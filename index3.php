	...
	<div class="banner">
		<div class="container">
			<div class="banner-info">
				<h1 class="animated fadeInLeftBig" data-wow-duration="1000ms" data-wow-delay="300ms">Arte en Azúcar<span>Prueba nuestro arte!</span></h1>
				<div class="banner-info1 animated wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
					<ul id="flexiselDemo1">			
						<li>
							<div class="banner-info1-grid">
								...
								<h3>Chocolate al Doble</h3>
								<p>Delicioso pastel hecho con dos tipo de chocolat.</p>
							</div>
						</li>
						<li>
							<div class="banner-info1-grid">
								<img src="images/15.jpg" alt=" " class="img-responsive" />
								<h3>Menta y Tamarindo</h3>
								<p>Dulce menta y sabor a tamarindo simulando perlas preciosas.</p>
							</div>
						</li>
						<li>
							<div class="banner-info1-grid">
								...
								<h3>Cajeta Fan</h3>
								<p>Cajeta con una base esponjosa, receta para fanaticos a la cajeta.
								</p>
							</div>
						</li>
					</ul>
					...
					<div class="more wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
						<a href="single.html" class="hvr-curl-bottom-right">Quiero Suscribirme!</a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="banner-bottom-grids">
				<div class="col-md-5 banner-bottom-grid wow fadeInRightBig" data-wow-duration="1000ms" data-wow-delay="300ms">
					<h2>Endulzate la vida &#128525;</h2>
					<p>En Parlour sabemos lo amargo que pueden ser los días,
						por lo mismo queremos compartir contigo un poco de alegría por medio
						de nuestros exquisitos postres y antojitos todo momento.
					</p>
					<div class="more">
						<a href="single.html" class="hvr-curl-bottom-right">Quiero Suscribirme!</a>
					</div>
				...
				<div class="col-md-6 banner-bottom-grid-1 wow flipInY" data-wow-duration="1000ms" data-wow-delay="300ms">
					<div class="banner-bottom-grid-11">
						...
						<div class="banner-bottom-grid-11-pos">
							<p>En Parlour tendremos a disposición las mejores suscripciones para nuestros usuarios,
								
							</p>
							<div class="more m1">
								<a href="single.html" class="hvr-curl-bottom-right">Quiero Suscrimirme YA! </a>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="newsletter">
		<div class="container">
			<div class="newsletter-info">
				...
				<p class="wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">Para mantenernos en contacto, coloca tu correo y te enviaremos las suscripciones &#128520;</p>
				<form class="wow fadeInLeftBig" data-wow-duration="1000ms" data-wow-delay="300ms">
					<input type="mail" value="Mi correo es" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Mi correo es';}" required="">
