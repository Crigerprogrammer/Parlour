					...
					<ul id="flexiselDemo1">			
						<li>
							<div class="banner-info1-grid">
								...
								<h3>Cake</h3>
								<p>Delicioso pastel hecho con productos de primera calidad.</p>
							</div>
						</li>
						<li>
							<div class="banner-info1-grid">
								...
								<h3>Cakesicle</h3>
								<p>Dulce paleta creada a partir de pastel para los pequeños antojos.</p>
							</div>
						</li>
						<li>
							<div class="banner-info1-grid">
								...
								<h3>Oreo Pop</h3>
								<p>Paleta con deliciosos trozos de Oreo cubierta de chocolate blanco 
									debes probarla!!!.
								</p>
							</div>
						</li>
